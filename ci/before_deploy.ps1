...
# 
Invoke-Expression '& "$($Env:Temp)\verpatch.exe" "$SRC_DIR\target\$($Env:TARGET)\release\se_shell.exe" "$VERSION" /va /s description "Star Entertainer Shell" /s company "Zwei&40 GmbH" /s copyright "(c) 2019"'
